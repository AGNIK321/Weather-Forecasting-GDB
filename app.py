...
/* ── Left Panel ── */
.left-panel {
    background: linear-gradient(180deg, #060e1e 0%, #071020 100%);
...
/* ── Current Now Card ── */
.now-card {
    background: linear-gradient(145deg, rgba(56, 182, 255, 0.08), rgba(56, 182, 255, 0.03));
...
/* ── Alert Box ── */
.alert-rain {
    background: linear-gradient(135deg, rgba(56,182,255,0.12), rgba(56,182,255,0.06));
...
with right_col:
    ...
    fig_fc.add_trace(go.Scatter(
        ...
        marker=dict(
            ...
            color=['#38b6ff' if f else '#1a4a6e' for f in forecast_df['rain_flag']],
    ...
    fig_fc.update_layout(
        ...
        yaxis=dict(range=[0, 105], ticksuffix='%', gridcolor='rgba(255,255,255,0.04)',
    ...
    if not hist_df.empty:
        ...
        fig_press.update_layout(
            ...
            yaxis=dict(gridcolor='rgba(255,255,255,0.04)',
                       tickfont=dict(color='rgba(180,140,255,0.4)', size=10, family='Space Mono'),
